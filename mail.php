...
$to = "reika.komiyama@mvrck.co.jp";

//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
$from = "reika.komiyama@mvrck.co.jp";
...
$subject = "【".@$_POST['お名前']."】様からお問い合わせがありました";
...
$require = array('個人情報の取り扱いについての確認');
...
$re_subject = "【セブンズ企画株式会社】お問い合わせありがとうございます";
...
お世話になっております。
セブンズ企画へのお問い合わせありがとうございました。

以下の内容でお問い合わせを受け付けいたしました。
3営業日以内に、こちらよりご連絡いたしますので
今しばらくお待ちくださいませ。
...
代表取締役：七條 典明
TEL：080-5372-7077
FAX：03-for 3772-2970
メール：shichijo-n@7kikaku.com
ーーーーーーーーーーーーーーーーーーーー
...
<head>
  ...
  <title>カスタムメイド・低価格な低酸素実験システム｜SEVEN’S PLANNING</title>
  <meta name="description" content="研究機関への納入実績多数。カスタムメイド・低価格な低酸素実験システムならSEVEN’S PLANNING。">
  ...
  <div id="wrapper">
    <main>
      <section class="fv">
        <div class="fv__container">
          <a href="./" class="fv__logo"><img src="img/fv_logo.svg" alt="SEVEN’S PLANNING"></a>
        </div>
      </section>
      <section class="form">
        <div class="form__container">
          <h1 class="form__title">入力内容のご確認</h1>
          <p class="form__text">以下の内容でお間違いなければ、送信ボタンを押してください。 </p>
          <form class="contents" action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
            ...
            <div class="contents__buttons">
              <button class="contents__button contents__button--edit" type="button" value="" onClick="history.back()">
                <img src="img/contents_button_edit.svg" alt="修正する">
              </button>
              <button class="contents__button contents__button--submit" type="submit" value="">
                <img src="img/contents_button_submit.svg" alt="送信する">
              </button>
            </div>
          </form>
        </div>
    ...
    <footer id="footer" class="footer">
      <div class="footer__container">
        <small>© 2019 seven’s plannnig Inc.</small>
      </div>
    </footer>
  </div>
</body>
...
<?php } else { ?> 送信ありがとうございました。 <br /> 送信は正常に完了しました。 <br /><br />
